...
export const postgresLogger = createChildLogger(config.log.children.postgresLogger);
export const redisLogger = createChildLogger(config.log.children.redisLogger);
